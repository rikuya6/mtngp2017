...
function main(){
  ...
  game.onload = function(){
    ...
    var noveltext = [
      '絵本描き「うん、よく出来たね。でも、もう少し登場人物が簡単に',
      '　　　　　ゴールに着くことが出来たかな」',
      false,
      '絵本描き「これからもたくさん手伝いをしてもらう。僕の物語が',
      '　　　　　良くなるように頑張って欲しい。」',
      false,
      '絵本描き「さぁ、これからは君が考えて登場人物を動かすんだ。',
      '　　　　　気持ちを考えることを忘れちゃいけないよ。」',
      false,
      '絵本描き「また会おう。次は立派なお手伝いとしてね。」',
      false,
      false
    ];
    ...
    sprite.addEventListener('touchstart', function() {
      ...
      if(noveltext.length == 0){
        let submit = document.getElementById("tutorial3B_novel");
        submit.submit();
        game.pause();
      }
    });
